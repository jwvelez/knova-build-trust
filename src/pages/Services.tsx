        ...
        <section id="facility-maintenance" className="pt-24 pb-24 px-6 md:px-8 bg-background">
          <div className="max-w-[1240px] mx-auto">
            ...
            {loading ? (
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <Accordion type="multiple" className="w-full space-y-3">
                      <AccordionItem value="cost" className="border border-border rounded-lg px-4 bg-background">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <div className="flex items-center gap-3 text-left">
                            <DollarSign className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            <h5 className="font-semibold text-base">Cost savings</h5>
                          </div>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 pl-8">
                      ...
                      <AccordionItem value="downtime" className="border border-border rounded-lg px-4 bg-background">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <div className="flex items-center gap-3 text-left">
                            <Clock className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            <h5 className="font-semibold text-base">Minimized downtime</h5>
                          </div>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 pl-8">
                          <p className="text-[15px] text-muted-foreground leading-relaxed">
                      ...
                      <AccordionItem value="energy" className="border border-border rounded-lg px-4 bg-background">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <div className="flex items-center gap-3 text-left">
                            <Leaf className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            <h5 className="font-semibold text-base">Improved energy efficiency</h5>
                          </div>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 pl-8">
                          <p className="text-[15px] text-muted-foreground leading-relaxed">
                      ...
                      <AccordionItem value="safety" className="border border-border rounded-lg px-4 bg-background">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <div className="flex items-center gap-3 text-left">
                            <Shield className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            <h5 className="font-semibold text-base">Enhanced safety</h5>
                          </div>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 pl-8">
                          <p className="text-[15px] text-muted-foreground leading-relaxed">
                      ...
                      <AccordionItem value="planning" className="border border-border rounded-lg px-4 bg-background">
                        <AccordionTrigger className="hover:no-underline py-4">
                          <div className="flex items-center gap-3 text-left">
                            <Calendar className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            <h5 className="font-semibold text-base">Better resource planning</h5>
                          </div>
                        </AccordionTrigger>
                        <AccordionContent className="pb-4 pl-8">
                          <p className="text-[15px] text-muted-foreground leading-relaxed">
                  ...
                  <div>
                    ...
                    <Accordion type="multiple" className="w-full space-y-3">
                      {[
                        { icon: Wind, title: "HVAC systems", desc: "We inspect, clean, and calibrate equipment to maintain performance, air quality, and efficiency." },
                        { icon: Plug, title: "Electrical systems", desc: "We service panels, wiring, and fixtures to prevent hazards and keep power stable." },
                        { icon: Droplet, title: "Plumbing systems", desc: "We clean and inspect drains and piping to prevent clogs, leaks, and water damage." },
                        { icon: Lightbulb, title: "Lighting systems", desc: "We maintain interior and exterior lighting and support LED retrofits to improve safety and reduce costs." },
                        { icon: Eye, title: "Safety equipment", desc: "We check fire alarms, sprinkler systems, and extinguishers to keep life-safety systems ready." },
                        { icon: Home, title: "Exterior maintenance", desc: "We inspect roofs, windows, facades, and lots to prevent water intrusion and exterior failures." },
                        { icon: ArrowUp, title: "Vertical transportation", desc: "We coordinate servicing of elevators and escalators for safe, reliable operation." },
                        { icon: Wrench, title: "General upkeep", desc: "We perform scheduled walkthroughs of building assets including floors, walls, doors, and gates." }
                      ].map((service, idx) => {
                        const Icon = service.icon;
                        return (
                          <AccordionItem key={idx} value={`service-${idx}`} className="border border-border rounded-lg px-4 bg-background">
                            <AccordionTrigger className="hover:no-underline py-4">
                              <div className="flex items-center gap-3 text-left">
                                <Icon className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                            ...
                            <AccordionContent className="pb-4 pl-8">
                              <p className="text-[15px] text-muted-foreground leading-relaxed">{service.desc}</p>
                            </AccordionContent>
                          </AccordionItem>
                        );
                      })}
                ...
                <div className="mt-16">
                  ...
                  <div>
                    ...
                    <Accordion type="multiple" className="w-full space-y-3">
                      {[
                        { icon: Wind, title: "HVAC failure", desc: "We repair or replace heating and cooling equipment to restore safe, comfortable conditions during peak weather." },
                        { icon: Droplet, title: "Plumbing issues", desc: "We respond to burst pipes, major leaks, and urgent plumbing failures to limit water damage." },
                        { icon: Zap, title: "Power outages", desc: "We troubleshoot electrical failures and coordinate generator support to restore power." },
                        { icon: AlertTriangle, title: "Structural damage", desc: "We address storm and impact damage and coordinate safe, code-compliant repairs." },
                        { icon: Flame, title: "Fire and life safety", desc: "We service affected fire alarms and sprinkler systems to confirm proper operation." },
                        { icon: CloudRain, title: "Disaster response", desc: "We provide emergency services and site cleanup as needed, including snow removal." }
                      ].map((scenario, idx) => {
                        const Icon = scenario.icon;
                        return (
                          <AccordionItem key={idx} value={`scenario-${idx}`} className="border border-border rounded-lg px-4 bg-background">
                            <AccordionTrigger className="hover:no-underline py-4">
                              <div className="flex items-center gap-3 text-left">
                                <Icon className="h-5 w-5 text-accent stroke-[2px] flex-shrink-0" />
                                <h5 className="font-semibold text-base">{scenario.title}</h5>
                              </div>
                            </AccordionTrigger>
                            <AccordionContent className="pb-4 pl-8">
                              <p className="text-[15px] text-muted-foreground leading-relaxed">{scenario.desc}</p>
                            </AccordionContent>
                          </AccordionItem>
                        );
                      })}
              ...
              // Desktop: Tabs with Cards Layout
